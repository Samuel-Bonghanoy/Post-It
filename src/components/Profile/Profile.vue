...
<template>
  ...
  <div class="bg-gray-100 app">
    <nav
      class="relative flex items-center justify-between w-full h-20 px-8 bg-white shadow"
    >
      <!-- login -->
    ...
    <main
      class="container grid grid-cols-1 gap-6 px-2 mx-12 mx-auto my-12 lg:grid-cols-2 w-2xl"
    >
      <aside class="">
        ...
        <div class="flex p-2 mt-6 bg-white rounded-lg shadow">
          <img
          ...
          <div class="flex flex-col justify-center w-full px-2 py-1">
            <div class="flex items-center justify-between">
              ...
              <svg
                ...
                class="w-5 h-5 text-gray-500 cursor-pointer hover:text-blue-400"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
        ...
        <div
          class="flex grid items-center justify-center w-full grid-cols-2 mt-5 space-x-4 overflow-y-scroll"
        >
          <div
            class="relative flex flex-col justify-between object-cover object-center w-full h-64 my-2 overflow-hidden text-gray-800 bg-white bg-cover rounded shadow-md cursor-pointer rounded-3xl"
            style="
              background-image: url('https://images.unsplash.com/reserve/8T8J12VQxyqCiQFGa2ct_bahamas-atlantis.jpg?ixlib=rb-1.2.1&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=crop&amp;w=1050&amp;q=80');
            "
          >
            <div
              class="absolute inset-0 z-0 opacity-50 bg-gradient-to-t from-green-400 to-blue-400"
            ></div>
            <div class="relative flex flex-row items-end w-full h-72">
              ...
              <div class="z-10 flex flex-col w-full p-6 rounded-lg">
                <h4
                  class="mt-1 text-xl font-semibold leading-tight text-white truncate"
                >
                  Loremipsum..
                </h4>
                <div class="flex items-center justify-between">
                  <div class="flex flex-col">
                    <h2
                      class="flex items-center text-sm font-normal text-gray-300"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        class="w-4 h-4 mr-1"
          ...
          <div
            class="relative flex flex-col justify-between object-cover object-center w-full h-64 my-2 overflow-hidden text-gray-800 bg-white bg-cover rounded shadow-md cursor-pointer rounded-3xl"
            style="
              background-image: url('https://images.unsplash.com/photo-1571896349842-33c89424de2d?ixlib=rb-1.2.1&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=crop&amp;w=800&amp;q=80');
            "
          >
            <div
              class="absolute inset-0 z-0 opacity-50 bg-gradient-to-t from-blue-500 to-yellow-400"
            ></div>
            <div class="relative flex flex-row items-end w-full h-72">
              <div class="absolute top-0 right-0 m-2">
                <svg
      ...
      <article class="">
        ...
        <div class="mb-6 bg-white rounded-lg shadow">
          <div class="flex flex-row px-2 py-3 mx-3">
            ...
            <div class="flex flex-col mt-1 mb-2 ml-4">
              ...
              <div class="flex w-full mt-1">
                <div
                  class="mr-1 text-xs text-blue-700 cursor-pointer font-base"
                >
                  SEO
                </div>
          ...
          <div class="px-2 mx-3 mt-6 text-sm font-medium text-gray-400 mb-7">
            <div class="grid grid-cols-6 col-span-2 gap-2">
              ...
              <div
                class="relative overflow-hidden rounded-xl col-span-2 max-h-[10rem]"
              >
                <div
                  class="absolute inset-0 flex items-center justify-center text-xl text-white bg-slate-900/80"
                >
                  + 23
                </div>
                <img
          ...
          <div class="px-2 mx-3 mb-6 text-sm text-gray-500">
          ...
          <div class="flex justify-start mb-4 border-t border-gray-100">
            <div class="flex w-full pt-2 pl-5 mt-1">
              <span
                class="w-8 h-8 px-2 pt-2 mr-2 text-center text-gray-400 transition duration-300 ease-out bg-white border rounded-full cursor-pointer hover:text-red-500"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
            ...
            <div class="flex justify-end w-full pt-2 pr-5 mt-1">
              <span
                class="w-8 h-8 px-2 py-2 mr-2 text-center text-blue-400 transition duration-300 ease-out bg-blue-100 rounded-full cursor-pointer hover:bg-blue-50"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
              ...
              <span
                class="h-8 px-2 py-2 text-center text-gray-100 transition duration-300 ease-out bg-gray-100 rounded-full cursor-pointer hover:bg-gray-50"
              >
                <svg
          ...
          <div class="flex w-full border-t border-gray-100">
            <div class="flex flex-row mx-5 mt-3 text-xs">
              <div
                class="flex items-center mb-2 mr-4 font-normal text-gray-700 rounded-md"
              >
                Comments:
            ...
            <div class="flex justify-end w-full mx-5 mt-3 text-xs">
              <div class="flex items-center mb-2 mr-4 text-gray-700 rounded-md">
                Likes:
          ...
          <div class="flex p-4 antialiased text-black">
            <img
              class="w-8 h-8 mt-1 mr-2 rounded-full"
          ...
          >
            ...
            <span class="absolute inset-y-0 right-0 flex items-center pr-6">
              ...
              >
                <svg
                  class="w-6 h-6 text-gray-400 transition duration-300 ease-out hover:text-blue-500"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
        ...
        <div class="bg-white rounded-lg shadow">
          <div class="flex flex-row px-2 py-3 mx-3">
            ...
            <div class="flex flex-col mt-1 mb-2 ml-4">
              ...
              <div class="flex w-full mt-1">
                ...
                <div class="text-xs font-thin text-gray-400">• 1 day ago</div>
              </div>
            </div>
          </div>
          <div class="border-b border-gray-100"></div>
          ...
          <div class="px-2 mx-3 mb-2 font-semibold text-gray-600">
          ...
          >
            ...
            <input
              type="search"
              class="w-full py-2 pl-4 pr-10 text-sm placeholder-gray-400 bg-gray-100 border border-transparent appearance-none rounded-tg focus:bg-white focus:outline-none focus:border-blue-500 focus:text-gray-900 focus:shadow-outline-blue"
              style="border-radius: 25px"
              placeholder="Post a comment..."
              autocomplete="off"
            />
